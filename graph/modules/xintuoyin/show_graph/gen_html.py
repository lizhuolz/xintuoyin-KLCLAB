...
file_path = "/data1/liwu/xintuoyin/getgraph/output_graph.jsonl"
datas = []
with open(file_path, 'r', encoding='utf-8') as f:
    for line in f:
        data = json.loads(line)
        if data["value"] != None and data["value"] != 'null' and data["value"] != "":
            datas.append(data)
...
for data in datas:
    text += "{source: '"+str(data['file_category']) +"', target: '"+ data['value'] +"', 'rela': '"+ str(data['key']) +"', type: 'resolved'},\n"
...
html_content = html_template % text
with open("/data1/liwu/xintuoyin/show_graph/output_graph.html", 'w', encoding='utf-8') as f:
