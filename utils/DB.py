...
PORT = 3306
USER = 'hagongda'
PASSWD = 'haG[o#8n.g]d68a'
DB_NAME = 'yf_cats_test2'
...
class DB:
    ...
    def __init__(self, sqlcoder_path = '/data1/public/models/llama-3-sqlcoder-8b/', init_llm=False, selector_path = '/data1/public/models/Qwen2.5-14B-Instruct/'): # L20-old
        # init MySQL
        self.conn = None
        self.cur = None
        self.host = HOST
