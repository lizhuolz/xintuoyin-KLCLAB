  ...
  <div class="feedback-management-container">
    <div class="header-section">
      ...
      <div class="filter-toolbar">
        ...
        <el-select v-model="reasonKeyword" placeholder="反馈原因分类" class="filter-item" style="width: 220px" clearable>
    ...
    <el-table :data="feedbackList" v-loading="loading" style="width: 100%; margin-top: 20px">
      ...
      <el-table-column prop="name" label="反馈人" width="120" />
    ...
    <el-dialog v-model="detailVisible" title="反馈详情" width="750px" custom-class="feedback-detail-dialog">
      <div v-if="currentDetail" class="feedback-detail-content">
        <div class="metadata-grid">
          <div class="meta-item"><span class="label">反馈人：</span><el-input :model-value="currentDetail.name" readonly /></div>
          <div class="meta-item"><span class="label">联系方式：</span><el-input :model-value="currentDetail.phone" readonly /></div>
          <div class="meta-item"><span class="label">反馈公司：</span><el-input :model-value="currentDetail.enterprise" readonly /></div>
          <div class="meta-item"><span class="label">反馈类型：</span><el-input model-value="点踩反馈" readonly /></div>
        </div>
...
import { aiApi, buildFeedbackPictureUrl } from '@/api/ai'
...
async function fetchFeedbacks() {
  loading.value = true
  try {
    const data = await aiApi.listFeedbacks(filters)
