  ...
  <div class="feedback-management-container">
    <div class="header-section">
      ...
      <div class="filter-toolbar">
        ...
        <el-select v-model="filters.feedback_type" placeholder="反馈类型" class="filter-item" style="width: 180px">
          <el-option label="点踩" value="点踩" />
          <el-option label="针对问题" value="针对问题" />
    ...
    <el-dialog v-model="detailVisible" title="反馈详情" width="750px" custom-class="feedback-detail-dialog">
      <div v-if="currentDetail" class="feedback-detail-content">
        <div class="metadata-grid">
          ...
          <div class="meta-item"><span class="label">反馈类型：</span><el-input :model-value="(currentDetail.feedback_type?.labels || ['点踩']).join(' / ')" readonly /></div>
        </div>
...
const filters = reactive({ name: '', enterprise: '', type: 'dislike', feedback_type: '点踩' })
